...
function f5() {
	var data = `<ul class="data">
		<button class="cls" onclick="closeViewBox()">Close</button>
					<li>Настоящее свидетельство подтверждает, что<br><b>ТУНГУЧБЕК УУЛУ БЕКЗАТ</b></li>
					<li>пол <b>мужской</b> дата рождения <b>20.04.2002</b></li>
					<li>место рождения <b>КЫРГЫЗСКАЯ РЕСПУБЛИКА</b></li>
					<li>поставлен(а) на учет в соответствии с Налоговым кодексом Российской Федерации<br>с присвоением <b>14.10.2020</b> ИНН <b>667808197740</b></li>
				</ul>`;
	view.innerHTML = data
	viewBox()
}
